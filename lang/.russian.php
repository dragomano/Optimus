...
$txt['optimus_default_og_image']      = 'Ссылка на изображение по умолчанию для мета-тега <strong>og:image</strong>';
$txt['optimus_topic_body_og_image']   = 'Использовать изображение в тексте первого сообщения на странице темы для мета-тега <strong>og:image</strong> (если есть)';
$txt['optimus_topic_attach_og_image'] = 'Использовать прикреплённое изображение для мета-тега <strong>og:image</strong> (если есть)';
...
// Диспетчер задач
$txt['scheduled_task_Optimus::scheduledTask']      = 'Генерация XML-карты форума';
$txt['scheduled_task_desc_Optimus::scheduledTask'] = 'Настройте периодичность создания карты, если хотите.';
