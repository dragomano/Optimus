...
$txt['optimus_favicon_help'] = '<hr />Générez votre propre favicon <a class="bbc_link" href="http://www.favicomatic.com/" target="_blank">ICI</a>. Ensuite, téléchargez les fichiers favicon à la racine du forum, et sauvegardez le code du générateur dans le champ de droite. Ce code sera chargé en tête des pages du site, entre les balises &lt;head&gt;&lt;/head&gt;.';
