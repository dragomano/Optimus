...
$txt['optimus_favicon_help'] = '<hr />Genera tu propio favicon <a class="bbc_link" href="http://www.favicomatic.com/" target="_blank">Aqu&iacute;</a>. A continuaci&oacute;n, cargue los archivos de favicon en la ra&iacute;z del foro y guarde el c&oacute;digo del sitio del generador en el campo de la derecha. Este c&oacute;digo se cargar&aacute; en la parte superior de las p&aacute;ginas del sitio, entre las etiquetas &lt;head&gt;&lt;/head&gt;.';
