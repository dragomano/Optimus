...
$txt['optimus_404_status_help']        = 'If this option is enabled, the corresponding error code (404 or 403) will be returned when requesting a page that does not exist or that is not allowed). See details <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes" target="_blank" rel="noopener"><strong>here</strong></a>.';
...
$txt['optimus_search_engines'] = array(
	...
	'Yandex' => array('yandex-verification', '<a href="https://webmaster.yandex.com/" target="_blank" rel="noopener"><strong>Yandex.Webmaster</strong></a>'),
	'Bing'   => array('msvalidate.01', '<a href="https://www.bing.com/toolbox/webmaster/" target="_blank" rel="noopener"><strong>Bing Webmaster</strong></a>')
);
