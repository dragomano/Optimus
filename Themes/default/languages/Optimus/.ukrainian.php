...
$txt['optimus_allow_change_desc']      = 'Дозволити окреме поле для опису теми (відображається при редагуванні теми)';
$txt['optimus_allow_change_keywords']  = 'Дозволити окреме поле для ключових слів теми (відображається при редагуванні теми)';
$txt['optimus_show_keywords_block']    = 'Відображати блок з ключовими словами над першим повідомленням теми';
$txt['optimus_404_status']             = 'Повертати <a href="https://goo.gl/1UHxeB" target="_blank" rel="noopener" class="bbc_link">код 403/404</a>, в залежності від статусу запитуваної сторінки';
...
$txt['optimus_extra_desc']  = 'Додавання додаткової <a href="https://ruogp.me/" target="_blank" rel="noopener">розмітки</a> для сторінок форуму.';
...
$txt['optimus_json_ld']          = 'Розмітка JSON-LD для «хлібних крихт»';
$txt['optimus_json_ld_help']     = 'JSON-LD — це спосіб передачі зв\'язаних даних (Linked Data, LD) із допомогою текстового формату JSON (JavaScript Object Notation). Формат JSON-LD розробив Консорціум Всесвітньої павутини (W3C). Використання текстового формату JSON дозволяє людям легко читати і писати документи, размічені з допомогою JSON-LD. Сторінки з розміткою JSON-LD полегшують структурування даних машинами і роспізнавання понять, для власників сайтів це важливо в контексті пошукового просування.<br><br>На практиці використання формату JSON-LD покращує представленість сайту в пошуковій видачі. Ви використовуєте розширені сниппети, які привертають увагу користувачів і підвищують клікабельність посилань. Зокрема, з допомогою JSON-LD можна розмічати дані для графи знань, відображати в SERP пошук по сайту і робити розмітку подій.<br><br>Увімкніть цю опцію, щоб генерувати розмітку <a href="https://json-ld.org/" target="_blank" rel="noopener" class="bbc_link"><strong>JSON-LD</strong></a> для «<a href="https://developers.google.com/search/docs/data-types/breadcrumbs?hl=ru" target="_blank" rel="noopener" class="bbc_link"><strong>хлібних крихт</strong></a>.';
...
$txt['optimus_robots_desc']  = 'До ваших послуг генератор правил для створення robots.txt.';
...
$txt['optimus_robots_hint'] = 'Сюди можна вставити власні правила або змінити вже існуючі:';
...
$txt['optimus_sitemap_desc']  = 'Optimus надає можливість створити просту xml-карту, для невеликих форумів.';

$txt['optimus_sitemap_enable']          = 'Створити і періодично поновлювати xml-карту форуму';
$txt['optimus_sitemap_enable_subtext']  = 'Поновлюватись така карта буде в залежності від налаштувань в <a href="%1$s" class="bbc_link">Диспетчері задач</a>.';
$txt['optimus_sitemap_link']            = 'Показувати посилання на xml-карту в подвалі форуму';
$txt['optimus_sitemap_name']            = 'Ім\'я файлу xml-карти (без розширення!)';
...
$txt['optimus_sitemap_boards']          = 'Додавати в карту посилання на розділи форуму<br><span class="smalltext error">Розділи, закриті для гостей, додані НЕ будуть.</span>';
$txt['optimus_sitemap_topics']          = 'Додавати в карту лише теми з кількістю відповідей понад';

$txt['optimus_sitemap_rec']       = ' Optimus поки не вміє розбивати файли на декілька частин.';
$txt['optimus_sitemap_url_limit'] = 'В файле sitemap повинно бути не більше 50 тисяч посилань!';
...
// Диспетчер задач
$txt['scheduled_task_optimus_sitemap']      = 'Генерація XML-карти форуму';
$txt['scheduled_task_desc_optimus_sitemap'] = 'Налаштуйте періодичність створення карти, якщо хочете.';
