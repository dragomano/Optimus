...
$txt['optimus_favicon_help'] = '<hr />G&eacute;n&eacute;rez votre propre favicon <a class="bbc_link" href="http://www.favicomatic.com/" target="_blank">ICI</a>. Ensuite, t&eacute;l&eacute;chargez les fichiers favicon &agrave; la racine du forum, et sauvegardez le code du g&eacute;n&eacute;rateur dans le champ de droite. Ce code sera charg&eacute; en t&ecirc;te des pages du site, entre les balises &lt;head&gt;...&lt;/head&gt;.';
