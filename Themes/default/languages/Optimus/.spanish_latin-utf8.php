...
$txt['optimus_404_status']        = 'Retorno <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes" target="_blank">Código 403/404</a> dependiendo del estado de la página solicitada';
...
$txt['optimus_favicon_desc']  = 'Crea tu propio ícono de foro. Se mostrará en el navegador en la pestaña antes del nombre de la página, así como en una imagen junto a la pestaña abierta y otros elementos de la interfaz.';
...
$txt['optimus_remove_last_bc_item'] = 'Las migas de pan correctas (el último elemento no será un enlace)'; // No encontré otro significado - I did not find another meaning
$txt['optimus_correct_prevnext']    = '<a href="http://googlewebmastercentral.blogspot.com/2011/09/pagination-with-relnext-and-relprev.html" target="_blank">Lo correcto es rel="siguiente" y rel="anterior"</a> (paginación por temas)';
...
$txt['optimus_sitemap_desc']  = '¿Quieres un mapa del sitio simple? Optimus puede generar sitemap.xml para pequeños foros. Simplemente active esta opción a continuación. Este mapa del sitio se actualizará según la configuración en <a href="%1$s">Administrador de tareas</a>.';
...
$txt['optimus_sitemap_url_limit']  = '¡El archivo de sitemaps no debe tener más de 50,000 URLs!';
$txt['optimus_sitemap_size_limit'] = '%1$s ¡el archivo no debe tener más de 10 MB!';
$txt['optimus_sitemap_xml_link']   = 'Sitemap XML';

$txt['optimus_donate_title'] = 'Donaciones';
$txt['optimus_donate_desc']  = 'Desde aquí puedes enviar donaciones al autor del mod.';
