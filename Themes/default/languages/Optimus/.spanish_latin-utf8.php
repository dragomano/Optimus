...
$txt['optimus_favicon_help'] = '<hr />Genera tu propio favicon <a class="bbc_link" href="http://www.favicomatic.com/" target="_blank">Aquí</a>. A continuación, cargue los archivos de favicon en la raíz del foro y guarde el código del sitio del generador en el campo de la derecha. Este código se cargará en la parte superior de las páginas del sitio, entre las etiquetas &lt;head&gt;&lt;/head&gt;.';
