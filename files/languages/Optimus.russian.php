...
$txt['optimus_sitemap_desc'] = 'Optimus Brave предоставляет возможность создать простенькую xml-карту, для небольших форумов. Обновляться такая карта будет при каждом создании новой темы.';
$txt['optimus_sitemap_enable'] = 'Создать и периодически обновлять xml-карту форума';
$txt['optimus_sitemap_link'] = 'Показывать ссылку на xml-карту форума в подвале';
$txt['optimus_sitemap_topic_size'] = 'Добавлять в карту только темы с количеством сообщений больше';
