<?php
// Template file for Optimus Brave © 2010-2013, Bugo
...
function template_common()
{
	...
	echo '
			...
			<div class="cat_bar">
				<h3 class="catbg">', $txt['optimus_sitemap_section'], '</h3>
			</div>
			...
			<div class="windowbg2">
				...
				<div class="content">
					<dl class="settings">
						<dt>
							<span>
								<label for="optimus_sitemap_enable">', $txt['optimus_sitemap_enable'], '</label>
							</span>
						</dt>
						<dd>
		...
		<form action="', $context['post_url'], '" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="windowbg2">
				...
				<div class="content">
					...
					<textarea id="optimus_count_code_css" name="optimus_count_code_css" cols="60" rows="2" style="width: 99%">', !empty($modSettings['optimus_count_code_css']) ? $modSettings['optimus_count_code_css'] : '', '</textarea>
					<br /><br />
