...
$txt['optimus_tpl_info']  = 'Possible variables: <strong>{board_name}</strong> &mdash; board name, <strong>{topic_name}</strong> &mdash; topic subject,<strong>{cat_name}</strong> &mdash; category name, <strong>{forum_name}</strong> &mdash; your forum name.';
...
$txt['optimus_templates'] = array(
	'board' => array('{board_name}', ''),
	'topic' => array('{topic_name}', '')
);
$txt['optimus_topic_description'] = 'Display the topic first message snippet as the meta-tag <strong>description</strong><br><span class="smalltext">Use <a href="http://custom.simplemachines.org/mods/index.php?mod=3012" target="_blank">Topic Descriptions mod</a> to create short descriptions for topics.</span>';
...
$txt['optimus_og_image']            = 'Use the first message attachment as Open Graph image';
