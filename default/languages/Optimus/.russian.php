...
$txt['optimus_tpl_info']  = 'Доступные переменные: <strong>{board_name}</strong> &mdash; название раздела, <strong>{topic_name}</strong> &mdash; название темы, <strong>{cat_name}</strong> &mdash; название категории, <strong>{forum_name}</strong> &mdash; название форума.';
...
$txt['optimus_topic_description'] = 'Выводить отрывок первого сообщения на странице темы в мета-теге <strong>description</strong><br><span class="smalltext">Для создания описаний к темам используйте мод <a href="http://dragomano.ru/translations/topic-descriptions" target="_blank">Topic Descriptions</a>.</span>';
